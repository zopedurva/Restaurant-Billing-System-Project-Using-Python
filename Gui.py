...
Button_TOTAL = Button(command=calculate_total)
window = tk.Tk()
...
SwimmingOn_Entry = tk.Entry(Frame_left)
SwimmingOn_Entry.place(relx=0.7, rely=0.4, height=35, relwidth=0.2, bordermode='ignore')
SwimmingOn_Entry.configure(background="white")
SwimmingOn_Entry.configure(disabledforeground="#a3a3a3")
SwimmingOn_Entry.configure(font="-family {Segoe UI} -size 14")
SwimmingOn_Entry.configure(foreground="#000000")
SwimmingOn_Entry.configure(insertbackground="black")
SwimmingOn_Entry.configure(borderwidth="5")
...
SwimmingOn_Checkbutton = tk.Checkbutton(Frame_left)
SwimmingOn_Checkbutton.configure(text="Swimming On The Beach")
SwimmingOn_Checkbutton.configure(variable= var4)
SwimmingOn_Checkbutton.place(relx=0.1, rely=0.4, height=35, bordermode='ignore')
SwimmingOn_Checkbutton.configure(font="-family {Segoe UI} -size 14")
SwimmingOn_Checkbutton.configure(background="#d9d9d9")
SwimmingOn_Checkbutton.configure(command=m.SwimmingOn)
