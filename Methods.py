...
def main():
    ...
    g.SwimmingOn_Entry.insert("end", "0")
    ...
    g.SwimmingOn_Entry.config(state="disabled")
...
def total():
    ...
    Latte, Espresso, Iced_latte, SwimmingOn, Cappucino = 2, 1.69, 3, 2.30, 2
    ...
    g.listbox_Drinks.insert("end", "Rs " + str('%.2f' % drink))
    g.listbox_Cakes.insert("end", "Rs " + str('%.2f' % cake))
    g.listbox_Charge.insert("end", "Rs " + str('%.2f' % charge))
    g.Tax_Listbox.insert("end", "Rs " + str('%.2f' % tax))
    g.Sub_Listbox.insert("end", "Rs " + str('%.2f' % sub))
    g.Total_Listbox.insert("end", "Rs " + str('%.2f' % full_total))
    ...
    if cash != 0:
        ...
        g.listbox_Remain.insert("end", "Rs " + str('%.2f' % remain))
...
def recipt():
    ...
    if g.var4.get() == 1: g.listbox.insert("end", "     Swimming On The Beach                           {}                                            {}".format(g.SexOn_Entry.get(), total_tuple[8]))
    ...
    g.listbox.insert("end", "=================================================")
    g.listbox.insert("end", "                                                 ")
    g.listbox.insert("end", ("     Cost of Drinks : " + "                                                                            Rs " + str('%.2f' % total_tuple[0])))
    g.listbox.insert("end", ("     Cost of Food Items : " + "                                                                    Rs " + str('%.2f' % total_tuple[1])))
    g.listbox.insert("end", ("     Service Charge : " + "                                                                           Rs " + str('%.2f' % total_tuple[2])))
    g.listbox.insert("end", ("     Paid Tax : " + "                                                                                      Rs " + str('%.2f' % total_tuple[3])))
    g.listbox.insert("end", ("     Total : " + "                                                                                           Rs " + str('%.2f' % total_tuple[4])))
    if float(g.Cash_Entry.get()) != 0: g.listbox.insert("end", "     Cash                                                                                               Rs {}".format('%.2f' % float(g.Cash_Entry.get())))
    if float(g.Cash_Entry.get()) != 0: g.listbox.insert("end", "     Remain                                                                                           Rs {}".format('%.2f' % float(total_tuple[23])))
...
def SwimmingOn():
    if g.var4.get() == 1:
        g.SwimmingOn_Entry.config(state="normal")
        g.SwimmingOn_Entry.delete(0, 5)
    else:
        g.SwimmingOn_Entry.delete(0, 5)
        g.SwimmingOn_Entry.insert("end", "0")
